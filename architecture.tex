...
To maximize throughput, we make the initiation interval (II) of a PE be equal to 1 (II=1), i.e., calculating one cell of the score matrix per cycle. 
...
the distributor checks the flag of the FIFO of each PE one by one to find the available PEs. 
