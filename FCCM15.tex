...
Existing wavefront-based methods ignored the fact that the S-W kernel is fed with significantly varied-size inputs in modern aligners, in which the S-W kernel is further optimized by exerting extensive pruning. 
